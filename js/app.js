...
var _questions = require('./questions.tag');

var _questions2 = _interopRequireDefault(_questions);

var _question = require('./question.tag');

var _question2 = _interopRequireDefault(_question);

var _raw = require('./raw.tag');
...
var MinecraftIRC = function () {
    function MinecraftIRC() {
        _classCallCheck(this, MinecraftIRC);
    }

    _createClass(MinecraftIRC, [{
        key: 'init',
        value: function init() {
            _riot2.default.mount(_questions2.default);
        }
    }]);
...
var riot = require('riot');
module.exports = riot.tag2('questions', '<question question="{currentQuestion}"></question>', '', '', function(opts) {
