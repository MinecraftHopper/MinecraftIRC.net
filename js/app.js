...
/* WEBPACK VAR INJECTION */(function($) {
    ...
    riot.tag2('question', '<h1 class="heading">{opts.question.heading}</h1> <p class="description"><raw content="{opts.question.description}"></raw></p> <h2 class="question-title"><raw content="{opts.question.question}"></raw></h2> <ul class="choices" show="{!opts.question.renderAsButtons}"> <li each="{opts.question.choices}"><input name="choice" class="choice" type="radio" riot-value="{to}" onchange="{onChange}">{text}</li> </ul> <div show="{opts.question.renderAsButtons}"> <button each="{opts.question.choices}" class="button" onclick="{onCustomButtonClick}" data-to="{to}" data-is-external-link="{isExternalLink}">{text}</button> </div> <div hide="{opts.question.isResolution}"> <button class="back-button is-hidden" onclick="{parent.displayPrev}">Back</button> <button class="disabled next-button" disabled onclick="{parent.displayNext}">Next</button> </div> <button class="enter-button is-hidden" onclick="{parent.displayEnd}">Enter</button>', '', '', function(opts) {
...
/* WEBPACK VAR INJECTION */(function($) {
    var riot = __webpack_require__(16)
    riot.tag2('questions', '<question question="{currentQuestion}"></question>', '', '', function(opts) {
        this.log = [];
        this.currentQuestion = {};
        let self = this;

        this.displayQuestion = function(name) {
...
var _raw = __webpack_require__(66);
...
(function (window, $) {
    $(function () {
        $(document).foundation();
        _riot2.default.mount('questions');
    });
